...
const txtPath = "C:\\Users\\travi\\.gemini\\antigravity\\brain\\12eef90f-48b2-4612-872d-00c9ff24dbba\\scratch\\extracted_ch2_new.txt";
...
console.log(`Extracted ${drills.length} unique main drill records from new Chapter 2 file.`);

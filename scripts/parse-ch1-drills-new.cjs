...
const txtPath = "C:\\Users\\travi\\.gemini\\antigravity\\brain\\12eef90f-48b2-4612-872d-00c9ff24dbba\\scratch\\extracted_ch1_new.txt";
...
for (let i = 0; i < lines.length; i++) {
  ...
  // Match heading format like "KK-001 – Stationary Drop Punt" or "KK-001 - Stationary Drop Punt"
...
console.log(`Extracted ${drills.length} unique main drill records from new Chapter 1 file.`);
